  ...
  return (
    <div className='px-3 sm:px-12 py-3 lg:py-5'>
        ...
        <div className='flex flex-wrap my-3 lg:my-5 text-[#2E3840] max-[780px]:justify-center'>
            ...
            <div className='p-5 rounded-lg bg-[#A0C3D2] w-[20rem] mt-5 mr-5 2xl:mr-7'>
            ...
            <div className='p-5 rounded-lg bg-[#B7B7B7] w-[20rem] mt-5 mr-5 2xl:mr-7'>
                <div className='flex font-bold items-center'>
            ...
            <div className='p-5 rounded-lg bg-[#AEC2B6] w-[20rem] mt-5 mr-5  2xl:mr-7'>
                <div className='flex font-bold items-center'>
            ...
            <div className='p-5 rounded-lg bg-[#D5B4B4]  w-[20rem] mt-5 mr-5 2xl:mr-7'>
                <div className='flex font-bold items-center'>
